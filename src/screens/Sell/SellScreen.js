...
import { Image, View, Text, StyleSheet, Dimensions, Button, TouchableOpacity, TextInput } from 'react-native';
...
class SellScreen extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      image: Asset.fromModule(require("../../../assets/images/CameraRoll.png")).uri,
      postState: {
        username: "NEW!",
